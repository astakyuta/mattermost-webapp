...
import {updateUserPassword, getUser} from 'mattermost-redux/actions/users';


import UpdatePasswordByAdmin from './update_password_by_admin.jsx';
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(UpdatePasswordByAdmin));
